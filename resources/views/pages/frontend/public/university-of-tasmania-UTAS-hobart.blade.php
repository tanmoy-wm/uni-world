              ...
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                      <div class="carousel-item">
                          <img class="d-block w-100" src="{{asset('assets/frontend/assets/images/courses-details/university-of-tasmania-UTAS-hobart-banner.jpg')}}" alt="" />
                      </div>
          ...
          <div class="sub-course-deta-two-tab">
                        ...
                        <div class="accordion" id="accordionExample">
                            <div class="card">
                                <div class="card-header collapsed" data-toggle="collapse" data-target="#collapse1" aria-expanded="false">
                                    <span class="title"><img src="{{asset('assets/frontend/assets/images/features-close.png')}}" alt="" />  Work While Studying</span>
                            ...
                            <div class="card">
                                <div class="card-header collapsed" data-toggle="collapse" data-target="#collapse2" aria-expanded="false">
                                    <span class="title"><img src="{{asset('assets/frontend/assets/images/features-yes.png')}}" alt="" /> Work While Studying</span>
                                    <span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header collapsed" data-toggle="collapse" data-target="#collapse3" aria-expanded="false">
                                    <span class="title"><img src="{{asset('assets/frontend/assets/images/features-close.png')}}" alt="" /> Conditional Offer Letter</span>
                                    <span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header collapsed" data-toggle="collapse" data-target="#collapse4" aria-expanded="false">
                                    <span class="title"><img src="{{asset('assets/frontend/assets/images/features-yes.png')}}" alt="" /> Accommodations</span>
                                    <span class="accicon"><i class="fas fa-angle-down rotate-icon"></i></span>
                                </div>
              ...
              <div class="col-lg-4">
                  ...
                  <div class="sub-prog-years-bg">
                      ...
                      <div class="sub-course-tt-box d-flex align-items-start justify-content-start">
                          <div class="sub-course-unt">
                              <img src="assets/frontend/assets/images/courses-details/money.png" alt="" />
                          </div>
                          <div class="sub-course-unt-title">
                      ...
                      <div class="sub-course-tt-box d-flex align-items-start justify-content-start">
                          <div class="sub-course-unt">
                              <img src="assets/frontend/assets/images/courses-details/money-tuition.png" alt="" />
                          </div>
                          <div class="sub-course-unt-title">
                      ...
                      <div class="sub-course-tt-box d-flex align-items-start justify-content-start">
                          <div class="sub-course-unt">
                              <img src="assets/frontend/assets/images/courses-details/application-fee.png" alt="" />
                          </div>
                          <div class="sub-course-unt-title">
                              <h6>£0.00 GBP</h6>
                              <div class="sub-course-country">
