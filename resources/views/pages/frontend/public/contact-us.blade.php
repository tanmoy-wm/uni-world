                ...
                <div class="header-abroad-main">
                    ...
                    <div class="col-lg-6">
                        <div class="header-img-abroad">
                            <img src="{{ asset('assets/frontend/assets/images/inner-banner/contact-us-banner.png') }}"
                                alt="" />
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="sub-contact-box">
                        <div class="sub-contact-icon">
                            <div class="sub-contact-icon-box">
                                <img src="{{ asset('assets/frontend/assets/images/canada-contact.png') }}" alt="" />
                            </div>
                            <h5>Canada</h5>
                        </div>
                        <div class="sub-contact-content">
                ...
                <div class="col-lg-3">
                    <div class="sub-contact-box">
                        <div class="sub-contact-icon">
                            <div class="sub-contact-icon-box">
                                <img src="{{ asset('assets/frontend/assets/images/india-contact.png') }}" alt="" />
                            </div>
                            <h5>India</h5>
                        </div>
                        <div class="sub-contact-content">
