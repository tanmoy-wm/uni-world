                        ...
                        <form class="form-sample" action="{{ route('university-registration') }}" method="POST">
                            ...
                            <div class="col-lg-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="University Name" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="alt_mobile_number"  class="form-control" placeholder="Alternative Mobile - Number">
                                </div>
                            </div>
