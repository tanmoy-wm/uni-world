                ...
                <div class="header-abroad-main">
                    <div class="col-lg-6">
                        <div class="header-abroad-content">
                            <h1>Studying in Canada: What You Need to Know</h1>
                            <p>Get All The Information You Need To Help Your Students Get Admission And Settle In Canada.
                                Enter Your Information Below To Access The Guide.</p>
                ...
                <div class="sub-how-we-help-main sub-advisory-pt-pb">
                    ...
                    <div class="col-lg-6">
                        <div class="sub-how-we-help-content">
                            ...
                            <ul>
                                <li>The benefits of studying in Canada</li>
                                <li>The study options available to students</li>
                                <li>How to apply for admission and cost of study</li>
                                <li>The steps and documentation required to enter and study in Canada</li>
                                <li>Work options available during study and after graduation</li>
                                <li>Tips on how to best prepare for living and studying in Canada</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="sub-access-guide-form">
                            <form>
                                ...
                                <div class="col-12 col-sm-6 col-lg-8">
                                    <div class="form-group sub-access-guide-form-num-two">
