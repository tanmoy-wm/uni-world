                ...
                <div class="header-abroad-main">
                    ...
                    <div class="col-lg-6">
                        <div class="header-img-abroad">
                            <img src="{{ asset('assets/frontend/assets/images/inner-banner/view-open-roles-banner.png') }}"
                                alt="" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-6 col-lg-6">
                        <div class="sub-making-edu-content">
                            <a href="javascript:;" data-toggle="modal" data-target="#exampleModal"><img
                                    src="{{ asset('assets/frontend/assets/images/05-success-stories.png') }}"
                                    alt="" /></a>
                        </div>
                    </div>
                    <div class="col-6 col-lg-6">
                        <div class="sub-making-edu-content">
                            <a href="javascript:;" data-toggle="modal" data-target="#exampleModal"><img
                                    src="{{ asset('assets/frontend/assets/images/06-success-stories.png') }}"
                                    alt="" /></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="carousel-item active">
                                    <div class="testimonial4_slide">
                                        <div class="col-lg-4"><img
                                                src="{{ asset('assets/frontend/assets/images/testimonial/05-testimonial.png') }}"
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="Australia">
                                        <div class="row">
                                            ...
                                            <div class="col-4 col-lg-3">
                                                <div class="sub-university-logo-box">
                                                    <img src="{{ asset('assets/images/university-logo/07.png') }}"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <div class="col-4 col-lg-3">
                                                <div class="sub-university-logo-box">
                                                    <img src="{{ asset('assets/images/university-logo/08.png') }}"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <div class="col-4 col-lg-3">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="sub-quality-applications-main">
                    ...
                    <div class="col-lg-6">
                        <div class="sub-quality-applications-two">
                            <img src="{{ asset('assets/images/02-quality-applications.png') }}" alt="" />
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="sub-uniwolc-title sub-choose-tt-pd">
                        ...
                        <p>Complete The Form Below And Our Partner Relations Team Will Be In Touch Soon.</p>
                    </div>
                </div>
