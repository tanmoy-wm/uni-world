                ...
                <div class="header-abroad-main">
                    <div class="col-lg-6">
                        <div class="header-abroad-content">
                            <h1>Studying in the US: <span>What You Need to Know</span></h1>
                            <p>Home To Half Of The World’s Top Universities, The United States (US) Is One Of The Most
                                Popular Study Destinations For International Students. Access Our Guide To Learn How
                                Students Can Benefit From The World-Class Educational Opportunities Which The The US Has To
                                Offer.</p>
                            <a href="javascript:;">Access The Guide</a>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="header-img-abroad">
                            <img src="{{ asset('assets/frontend/assets/images/inner-banner/featured-study-destinations-banner.png') }}"
                                alt="" />
                        </div>
                    </div>
                </div>
    ...
    <section class="sub-new-awolc-bg pt-0">
        <div class="container">
            <div class="row">
                ...
                <div class="sub-learn-about-pt">
                    <div class="col-lg-3">
                        <div class="sub-students-box sub-learn-about-text">
                            <img src="{{ asset('assets/frontend/assets/images/01-help-students.png') }}" alt="" />
                            <h5>The US education system and study options </h5>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="sub-students-box sub-learn-about-text">
                            ...
                            <h5>The admissions process, application deadlines, and study costs</h5>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="sub-students-box sub-learn-about-text">
                            ...
                            <h5>The steps and documentation available to obtain a study visa</h5>
                        </div>
                    </div>
