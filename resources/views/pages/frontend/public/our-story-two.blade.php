                ...
                <div class="header-abroad-main">
                    ...
                    <div class="col-lg-6">
                        <div class="header-img-abroad">
                            <img src="{{ asset('assets/frontend/assets/images/inner-banner/our-story-two-banner.png') }}"
                                alt="" />
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="sub-best-img-programs">
                        <img src="{{ asset('assets/frontend/assets/images/quality-applications.png') }}" alt="" />
    ...
    <section class="sub-new-awolc-bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="sub-plat-img-support">
                        <img src="{{ asset('assets/frontend/assets/images/what-we-do.jpg') }}" alt="" />
                        <div class="sub-story-btn-pt">
                    ...
                    <div class="col-lg-6">
                        <div class="sub-best-img-programs">
                            <a href="javascript:;" data-toggle="modal" data-target="#exampleModal"><img
                                    src="{{ asset('assets/frontend/assets/images/how-we-help-three.png') }}"
                                    alt="" /></a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="col-lg-4">
                    <div class="main-universities-blog">
                        <div class="sub-img-universities">
                            <img src="{{ asset('assets/frontend/assets/images/get-started-uniwolc/01-get-started-uniwolc.jpg') }}"
                                alt="" />
                        </div>
