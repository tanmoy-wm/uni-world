                    ...
                    <div class="col-lg-6">
                        <div class="header-img-abroad">
                            <a href="javascript:;" data-toggle="modal" data-target="#exampleModal"><img
                                    src="{{ asset('assets/frontend/assets/images/inner-banner/students-banner.png') }}"
                                    alt="" /></a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="{{ asset('assets/frontend/assets/images/why-choose/01-simple-application.png') }}"
                                alt="" />
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="{{ asset('assets/frontend/assets/images/why-choose/02-admission-counselling.png') }}"
                                alt="" />
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="{{ asset('assets/frontend/assets/images/why-choose/04-financial-guidance.png') }}"
                                alt="" />
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="{{ asset('assets/frontend/assets/images/why-choose/05-visa-assistance.png') }}"
                                alt="" />
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="sub-choose-box">
                        <div class="sub-img-choose">
                            <img src="{{ asset('assets/frontend/assets/images/why-choose/06-continuous-support.png') }}"
                                alt="" />
                        </div>
                                ...
                                <div class="carousel-item active">
                                    <div class="testimonial4_slide">
                                        <div class="col-lg-4"><img
                                                src="{{ asset('assets/frontend/assets/images/testimonial/02-testimonial.png') }}"
