        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="reports">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('reports.payment') }}">Payments</a>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('reports.staff') }}">Staff</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('reports.student') }}">Student</a></li>
                </ul>
            </div>
        </li>
